...
# this is the save feature, which saves the game everytime "bavis" is run
        ...
        filesave.write('Bavis amount: '+str(bavis_counter)+' Golden Bavis amount: '+str(g_bavis_counter)+' Multiplier: '+str(multiplier)+' Lives: '+str(lives)+' Hardcore: '+str(hardcore)+' Luck: '+str(luck)+' Prestige: '+str(prestige)+' Rebirths: '+str(rebirth))
        filesave.close()
